...
import 'package:songlib/model/exceptions/general_network_error.dart';
...
void main() {
  ...
  group('After init', () {
    ...
    group('onDownloadClicked', () {
      ...
      test('TodoListViewModel onDownloadClicked with KiolezoFlutterError', () async {
        ...
        verify(todoRepo.fetchTodos()).calledOnce();
        expect(sut.isLoading, false);
        expect(sut.errorKey, LocalizationsEn.errorGeneral);
        verifyNoMoreInteractions(todoRepo);
        verifyZeroInteractions(navigator);
      });
      test('TodoListViewModel onDownloadClicked with no KiolezoFlutterError', () async {
