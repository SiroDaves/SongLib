...
class _ErrorScreenState extends State<ErrorScreen> with ErrorNavigatorMixin {
        ...
        child: Column(
          ...
          children: [
            MaterialButton(
              ...
              color: Colors.amber,
              onPressed: () {
                showErrorWithLocaleKey(LocalizationsEn.errorUnauthorized);
              },
            ),
            MaterialButton(
  ...
  @override
  void showErrorWithLocaleKey(String errorGeneral, {List? args}) {
    // TODO: implement showErrorWithLocaleKey
  }
}
