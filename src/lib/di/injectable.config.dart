...
import '../database/myapp_database.dart' as _i10;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i10.MyappDatabase>(() => registerModule
      .provideMyappDatabase(get<_i6.DatabaseConnection>()));
  ...
  gh.lazySingleton<_i16.TodoDaoStorage>(
      () => _i16.TodoDaoStorage(get<_i10.MyappDatabase>()));
