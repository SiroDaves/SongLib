class AppConstants {
  ...
  static const doneSelectingBody = "If you are done selecting please proceed ahead. We can always bring you back to reselect.";
  static const noSelection = "Oops! No selection found";
  static const noSelectionBody = "Please select at least 1 book to proceed to the next step.";
  static const noConnection = "Ooops! You weren't supposed to see this!";
  static const noConnectionBody = "If you have reliable internet connection, then our servers are down. It's one thing or the other, we can't tell which is which.";
}
