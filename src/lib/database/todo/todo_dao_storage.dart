...
abstract class TodoDaoStorage {
  @factoryMethod
  factory TodoDaoStorage(MyappDatabase db) = _TodoDaoStorage;
...
class _TodoDaoStorage extends DatabaseAccessor<MyappDatabase> with _$_TodoDaoStorageMixin implements TodoDaoStorage {
  _TodoDaoStorage(MyappDatabase db) : super(db);
