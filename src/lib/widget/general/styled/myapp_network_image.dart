    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return SizedBox(
          height: imgHeight,
          width: imgWidth,
          child: _MyappBetterNetworkImage(
            imageUrl: correctUrl,
            height: imgHeight,
            width: imgWidth,
            fit: fit,
...
class _MyappBetterNetworkImage extends StatefulWidget {
  ...
  const _MyappBetterNetworkImage({
  ...
  @override
  _MyappBetterNetworkImageState createState() => _MyappBetterNetworkImageState();
}

class _MyappBetterNetworkImageState extends State<_MyappBetterNetworkImage> {
  ...
  @override
  void didUpdateWidget(_MyappBetterNetworkImage oldWidget) {
