...
import 'package:songlib/util/cache/cache_controlling.dart';
import 'package:songlib/util/env/flavor_config.dart';
import 'package:flutter/material.dart';
import 'package:get_it/get_it.dart';
import 'package:icapps_architecture/icapps_architecture.dart';

class SongLibNetworkImage extends StatelessWidget {
  final String? url;
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return SizedBox(
          height: imgHeight,
          width: imgWidth,
          child: _SongLibBetterNetworkImage(
            imageUrl: correctUrl,
            height: imgHeight,
            width: imgWidth,
            fit: fit,
...
class _SongLibBetterNetworkImage extends StatefulWidget {
  ...
  const _SongLibBetterNetworkImage({
  ...
  @override
  _SongLibBetterNetworkImageState createState() => _SongLibBetterNetworkImageState();
}

class _SongLibBetterNetworkImageState extends State<_SongLibBetterNetworkImage> {
  ...
  @override
  void didUpdateWidget(_SongLibBetterNetworkImage oldWidget) {
