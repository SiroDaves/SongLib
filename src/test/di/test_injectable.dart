...
import 'package:songlib/database/todo/todo_dao_storage.dart';
...
T getTheme<T>(BuildContext context) => MyappTheme.of(context) as T; // ignore: avoid_as
...
abstract class RegisterModule {
  ...
  @singleton
  MyappDatabase get flutterTemplateDatabase => MyappDatabase(NativeDatabase.memory());
