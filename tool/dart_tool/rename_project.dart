...
const originalClassNamePrefix = 'KiolezoFlutter';
const originalIOSBundleIdentifier = 'com.jacksiro.songlib';
const originalAndroidPackageName = 'com.jacksiro.songlib';
const originalAndroidFolderPath = 'com/jacksiro/songlib';
const originalAppName = 'Kiolezo Flutter';
const originalDescription = 'A template to jump start your flutter app';

void main() {
  Logger.info('Enter application name (eg: Kiolezo Flutter):');
  final appName = stdin.readLineSync();
  Logger.info('Enter description for the pubspec.yaml:');
  final description = stdin.readLineSync();
  Logger.info('Enter Dart Package Name (eg: songlib):');
  final dartPackageName = stdin.readLineSync();
  Logger.info('Enter Dart Class Name Prefix (eg: KiolezoFlutter):');
