...
class $EditsTableTable extends EditsTable
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'edits_table';
  @override
  ...
  Edits map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Edits(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}id'])!,
      editId: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}edit_id'])!,
      user: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}user'])!,
...
class $HistorysTableTable extends HistorysTable
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'historys_table';
  @override
...
class $ListedsTableTable extends ListedsTable
  ...
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      ...
      defaultConstraints:
          GeneratedColumn.constraintIsAlways('PRIMARY KEY AUTOINCREMENT'));
  static const VerificationMeta _listedIdMeta =
      const VerificationMeta('listedId');
  @override
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'listeds_table';
  @override
  ...
  Listeds map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Listeds(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}id'])!,
      listedId: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}listed_id'])!,
      user: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}user'])!,
...
class $SearchsTableTable extends SearchsTable
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'searchs_table';
  @override
  ...
  Searchs map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Searchs(
      ...
      searchId: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}search_id'])!,
      title: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}title'])!,
      created: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}created'])!,
