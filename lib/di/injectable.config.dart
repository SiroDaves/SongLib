...
import '../repository/web_repository.dart' as _i39;
...
import '../vm/home/history_vm.dart' as _i32;
import '../vm/home/home_vm.dart' as _i33;
import '../vm/home/lists_vm.dart' as _i34;
...
import '../webservice/api_client.dart' as _i38;
import '../webservice/web_service.dart' as _i37;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i32.HistoryVm>(
      () => _i32.HistoryVm(get<_i21.DbRepository>(), get<_i23.LocalStorage>()));
  gh.factory<_i33.HomeVm>(
      () => _i33.HomeVm(get<_i21.DbRepository>(), get<_i23.LocalStorage>()));
  gh.factory<_i34.ListsVm>(
      () => _i34.ListsVm(get<_i21.DbRepository>(), get<_i23.LocalStorage>()));
  gh.singleton<_i35.NetworkRefreshInterceptor>(
      _i35.NetworkRefreshInterceptor(get<_i27.RefreshRepository>()));
  ...
  gh.singleton<_i37.WebService>(_i38.ApiClient(get<_i36.Dio>()),
      registerFor: {_dev, _prod});
  gh.lazySingleton<_i39.WebRepository>(
      () => _i39.WebRepository(get<_i37.WebService>()));
  gh.factory<_i40.SelectionVm>(() => _i40.SelectionVm(get<_i39.WebRepository>(),
