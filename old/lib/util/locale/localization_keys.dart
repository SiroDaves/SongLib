...
class LocalizationKeys {
  ...
  ///
  /// es:  **'Información'**
  static const careerInfoTitle = 'careerInfoTitle';
  ...
  static const careerFinishedEarnings = 'careerFinishedEarnings';
  ...
  ///
  /// es:  **'Tienes:'**
  static const careerMoney = 'careerMoney';
  ...
  ///
  /// es:  **'Raza local'**
  static const careerLocalRace = 'careerLocalRace';
  ...
  ///
  /// es:  **'Raza Nacional'**
  static const careerNationalRace = 'careerNationalRace';
  ...
  static const careerContinentalRace = 'careerContinentalRace';
  ...
  ///
  /// es:  **'Tour Nacional'**
  static const careerNationalTour = 'careerNationalTour';
  ...
  ///
  /// es:  **'Tour continental'**
  static const careerContinentalTour = 'careerContinentalTour';
  ...
  static const careerInternationalRace = 'careerInternationalRace';
  ...
  static const careerInternationalTour = 'careerInternationalTour';
  ...
  ///
  /// es:  **'Gira mundial'**
  static const careerWorldTour = 'careerWorldTour';
  ...
  static const careerWinnerEarnings = 'careerWinnerEarnings';
  ...
  static const careerBlocked = 'careerBlocked';
  ...
  static const careerRaceRiders = 'careerRaceRiders';
  ...
  static const careerRaceDuration = 'careerRaceDuration';
  ...
  ///
  /// es:  **'Tipo de mapa:'**
  static const careerRaceType = 'careerRaceType';
  ...
  ///
  /// es:  **'Tus pasajeros'**
  static const upgradesRiders = 'upgradesRiders';
  ...
  ///
  /// es:  **'Clasificaciones'**
  static const upgradesRankings = 'upgradesRankings';
  ...
  ///
  /// es:  **'Tipo de carrera'**
  static const upgradesRaceTypes = 'upgradesRaceTypes';
  ...
  ///
  /// es:  **'carrera única'**
  static const singleRaceButton = 'singleRaceButton';
  ...
  ///
  /// es:  **'recorrido'**
  static const tourButton = 'tourButton';
  ...
  ///
  /// es:  **'menú principal'**
  static const mainMenuButton = 'mainMenuButton';
  ...
  ///
  /// es:  **'actualizaciones'**
  static const upgradesButton = 'upgradesButton';
  ...
  ///
  /// es:  **'configurar raza'**
  static const singleRaceTitle = 'singleRaceTitle';
  ...
  ///
  /// es:  **'Equipos:'**
  static const raceTeams = 'raceTeams';
  ...
  ///
  /// es:  **'Riders:'**
  static const raceRiders = 'raceRiders';
  ...
  ///
  /// es:  **'Plano'**
  static const raceTypeFlat = 'raceTypeFlat';
  ...
  ///
  /// es:  **'Adoquinado'**
  static const raceTypeCobbled = 'raceTypeCobbled';
  ...
  ///
  /// es:  **'Hilled'**
  static const raceTypeHilled = 'raceTypeHilled';
  ...
  ///
  /// es:  **'Pesado'**
  static const raceTypeHeavy = 'raceTypeHeavy';
  ...
  ///
  /// es:  **'Longitud:'**
  static const raceDuration = 'raceDuration';
  ...
  ///
  /// es:  **'Corto'**
  static const raceDurationShort = 'raceDurationShort';
  ...
  ///
  /// es:  **'Medio'**
  static const raceDurationMedium = 'raceDurationMedium';
  ...
  ///
  /// es:  **'Long'**
  static const raceDurationLong = 'raceDurationLong';
  ...
  ///
  /// es:  **'Muy largo'**
  static const raceDurationVeryLong = 'raceDurationVeryLong';
  ...
  static const tourTitle = 'tourTitle';
  ...
  ///
  /// es:  **'Créditos'**
  static const creditsTitle = 'creditsTitle';
  ...
  static const helpHome1 = 'helpHome1';
  ...
  static const helpHome2 = 'helpHome2';
  ...
  static const helpHome3 = 'helpHome3';
  ...
  static const helpBasicsTitle = 'helpBasicsTitle';
  ...
  static const helpBasics1 = 'helpBasics1';
  ...
  ///
  /// es:  **'Siguiente'**
  static const helpBasics2 = 'helpBasics2';
  ...
  static const helpBasics3 = 'helpBasics3';
  ...
  static const helpBasics4 = 'helpBasics4';
  ...
  static const helpBasics5 = 'helpBasics5';
  ...
  static const helpBasics6 = 'helpBasics6';
  ...
  ///
  /// es:  **'Tipos de mapas'**
  static const helpMapTypesTitle = 'helpMapTypesTitle';
  ...
  static const helpMapTypes1 = 'helpMapTypes1';
  ...
  static const helpMapTypes2 = 'helpMapTypes2';
  ...
  static const helpMapTypes3 = 'helpMapTypes3';
  ...
  static const helpResults1 = 'helpResults1';
  ...
  static const helpResults2 = 'helpResults2';
  ...
  static const helpResults3 = 'helpResults3';
  ...
  static const helpResults4 = 'helpResults4';
  ...
  static const helpResults5 = 'helpResults5';
  ...
  static const helpResults6 = 'helpResults6';
  ...
  ///
  /// es:  **'Tours'**
  static const helpToursTitle = 'helpToursTitle';
  ...
  static const helpTours = 'helpTours';
  ...
  ///
  /// es:  **'Estrategia'**
  static const helpStrategyTitle = 'helpStrategyTitle';
  ...
  static const helpStrategy = 'helpStrategy';
  ...
  ///
  /// es:  **'Configuración'**
  static const helpSettingsTitle = 'helpSettingsTitle';
  ...
  static const helpSettings1 = 'helpSettings1';
  ...
  static const helpSettings2 = 'helpSettings2';
  ...
  static const helpSettings3 = 'helpSettings3';
  ...
  static const helpSettings4 = 'helpSettings4';
  ...
  static const helpSettings5 = 'helpSettings5';
  ...
  ///
  /// es:  **'Dificultad'**
  static const helpSettings6 = 'helpSettings6';
  ...
  static const helpSettings7 = 'helpSettings7';
  ...
  static const helpMoreTitle = 'helpMoreTitle';
  ...
  static const helpMore = 'helpMore';
  ...
  ///
  /// es:  **'próxima carrera'**
  static const nextRaceTitle = 'nextRaceTitle';
  ...
  static const nextRaceRacesDone = 'nextRaceRacesDone';
  ...
  ///
  /// es:  **'fuera de'**
  static const nextRaceOf = 'nextRaceOf';
  ...
  ///
  /// es:  **'Mejor piloto:'**
  static const nextRaceBestRider = 'nextRaceBestRider';
  ...
  static const settingsAutofollowThreshold = 'settingsAutofollowThreshold';
  ...
  static const settingsAutofollowAskBelowThreshold = 'settingsAutofollowAskBelowThreshold';
  ...
  ///
  /// es:  **'Velocidad de movimiento del ciclista'**
  static const settingsCyclistMoveSpeed = 'settingsCyclistMoveSpeed';
  ...
  ///
  /// es:  **'Lento'**
  static const settingsCyclistMoveSpeedSlow = 'settingsCyclistMoveSpeedSlow';
  ...
  ///
  /// es:  **'Normal'**
  static const settingsCyclistMoveSpeedNormal = 'settingsCyclistMoveSpeedNormal';
  ...
  ///
  /// es:  **'Rápido'**
  static const settingsCyclistMoveSpeedFast = 'settingsCyclistMoveSpeedFast';
  ...
  ///
  /// es:  **'Omitir'**
  static const settingsCyclistMoveSpeedSkip = 'settingsCyclistMoveSpeedSkip';
  ...
  static const settingsCameraAutoMove = 'settingsCameraAutoMove';
  ...
  ///
  /// es:  **'Desactivado'**
  static const settingsCameraAutoMoveDisabled = 'settingsCameraAutoMoveDisabled';
  ...
  ///
  /// es:  **'Seleccionar solo'**
  static const settingsCameraAutoMoveSelectOnly = 'settingsCameraAutoMoveSelectOnly';
  ...
  static const settingsCameraAutoMoveSelectAndFollow = 'settingsCameraAutoMoveSelectAndFollow';
  ...
  ///
  /// es:  **'Dificultad'**
  static const settingsDifficulty = 'settingsDifficulty';
  ...
  ///
  /// es:  **'Fácil'**
  static const settingsDifficultyEasy = 'settingsDifficultyEasy';
  ...
  ///
  /// es:  **'Normal'**
  static const settingsDifficultyNormal = 'settingsDifficultyNormal';
  ...
  ///
  /// es:  **'Difícil'**
  static const settingsDifficultyHard = 'settingsDifficultyHard';
  ...
  ///
  /// es:  **'Necesitas lanzar'**
  static const followAmount = 'followAmount';
  ...
  ///
  /// es:  **'Seguir'**
  static const followFollow = 'followFollow';
  ...
  ///
  /// es:  **'Salir'**
  static const followLeave = 'followLeave';
  ...
  static const followAuto = 'followAuto';
  ...
  ///
  /// es:  **'paused'**
  static const pausedTitle = 'pausedTitle';
  ...
  ///
  /// es:  **'Ganado'**
  static const raceGained = 'raceGained';
  ...
  ///
  /// es:  **'Tutorial'**
  static const tutorialTitle = 'tutorialTitle';
  ...
  ///
  /// es:  **'Bienvenido'**
  static const tutorialWelcomeTitle = 'tutorialWelcomeTitle';
  ...
  ///
  /// nl:  **'Welkom bij SongLib, ik hoop dat je geniet van je verblijf. Er zijn een paar items die verwarrend kunnen zijn, maar ik zal ze uitleggen wanneer we ze tegenkomen. Als u ooit meer hulp nodig heeft, kunt u naar de helppagina gaan (i rechtsonder). (Games worden automatisch opgeslagen). Laten we nu beginnen!'**
  ///
  ...
  static const tutorialWelcomeDescription = 'tutorialWelcomeDescription';
  ...
  ///
  /// es:  **'Carrera'**
  static const tutorialCareerTitle = 'tutorialCareerTitle';
  ...
  static const tutorialCareerDescription = 'tutorialCareerDescription';
  ...
  ///
  /// es:  **'Raza única'**
  static const tutorialSingleRaceTitle = 'tutorialSingleRaceTitle';
  ...
  static const tutorialSingleRaceDescription = 'tutorialSingleRaceDescription';
  ...
  ///
  /// es:  **'Tour'**
  static const tutorialTourTitle = 'tutorialTourTitle';
  ...
  static const tutorialTourDescription = 'tutorialTourDescription';
  ...
  static const tutorialOpenRaceTitle = 'tutorialOpenRaceTitle';
  ...
  static const tutorialOpenRaceDescription = 'tutorialOpenRaceDescription';
  ...
  ///
  /// es:  **'Tu turno'**
  static const tutorialThrowDiceTitle = 'tutorialThrowDiceTitle';
  ...
  static const tutorialThrowDiceDescription = 'tutorialThrowDiceDescription';
  ...
  static const tutorialSelectPositionTitle = 'tutorialSelectPositionTitle';
  ...
  static const tutorialSelectPositionDescription = 'tutorialSelectPositionDescription';
  ...
  ///
  /// es:  **'Seguir ... o no'**
  static const tutorialFollowOrNotTitle = 'tutorialFollowOrNotTitle';
  ...
  static const tutorialFollowOrNotDescription = 'tutorialFollowOrNotDescription';
  ...
  ///
  /// es:  **'No puedo seguir'**
  static const tutorialCantFollowTitle = 'tutorialCantFollowTitle';
  ...
  static const tutorialCantFollowDescription = 'tutorialCantFollowDescription';
  ...
  ///
  /// es:  **'Quizás aún sigas'**
  static const tutorialStillFollowTitle = 'tutorialStillFollowTitle';
  ...
  static const tutorialStillFollowDescription = 'tutorialStillFollowDescription';
  ...
  ///
  /// es:  **'Terreno difícil'**
  static const tutorialDifficultTerrainTitle = 'tutorialDifficultTerrainTitle';
  ...
  static const tutorialDifficultTerrainDescription = 'tutorialDifficultTerrainDescription';
  ...
  ///
  /// es:  **'Cuesta abajo'**
  static const tutorialDownhillTitle = 'tutorialDownhillTitle';
  ...
  static const tutorialDownhillDescription = 'tutorialDownhillDescription';
  ...
  ///
  /// es:  **'¡Sprint!'**
  static const tutorialSprintTitle = 'tutorialSprintTitle';
  ...
  static const tutorialSprintDescription = 'tutorialSprintDescription';
  ...
  ///
  /// es:  **'¡Finalizar!'**
  static const tutorialFinishTitle = 'tutorialFinishTitle';
  ...
  static const tutorialFinishDescription = 'tutorialFinishDescription';
  ...
  ///
  /// es:  **'Clasificaciones'**
  static const tutorialRankingsTitle = 'tutorialRankingsTitle';
  ...
  static const tutorialRankingsDescription = 'tutorialRankingsDescription';
  ...
  ///
  /// es:  **'Configuración'**
  static const tutorialSettingsTitle = 'tutorialSettingsTitle';
  ...
  static const tutorialSettingsDescription = 'tutorialSettingsDescription';
  ...
  static const tutorialFirstTourFinishedTitle = 'tutorialFirstTourFinishedTitle';
  ...
  static const tutorialFirstTourFinishedDescription = 'tutorialFirstTourFinishedDescription';
  ...
  ///
  /// es:  **'Dinero'**
  static const tutorialFirstCareerTitle = 'tutorialFirstCareerTitle';
  ...
  static const tutorialFirstCareerDescription = 'tutorialFirstCareerDescription';
  ...
  ///
  /// es:  **'Actualizaciones'**
  static const tutorialUpgradesTitle = 'tutorialUpgradesTitle';
  ...
  static const tutorialUpgradesDescription = 'tutorialUpgradesDescription';
  ...
  ///
  /// es:  **'resultados'**
  static const resultsTitle = 'resultsTitle';
  ...
  ///
  /// es:  **'hora'**
  static const resultsTimeTitle = 'resultsTimeTitle';
  ...
  ///
  /// es:  **'Jóvenes jinetes'**
  static const resultsYoungRidersTitle = 'resultsYoungRidersTitle';
  ...
  ///
  /// es:  **'Puntos'**
  static const resultsPointsTitle = 'resultsPointsTitle';
  ...
  ///
  /// es:  **'Montaña'**
  static const resultsMountainTitle = 'resultsMountainTitle';
  ...
  static const discordServerIntro = 'discordServerIntro';
  ...
  static const discordServerUrl = 'discordServerUrl';
  ...
  static const selectionText = 'selectionText';
